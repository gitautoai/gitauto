...
test_log = """utils/files/test_should_test_file.py:534: AssertionError
=============================== warnings summary ===============================
...
print(result)
print("\n=== EXPECTED ===")
expected = """utils/files/test_should_test_file.py:534: AssertionError
...
for i, (r, e) in enumerate(zip(result_lines, expected_lines)):
    if r != e:
        print(f"Difference at line {i}: got {repr(r)}, expected {repr(e)}")
        break
