...
def test_clone_and_install_no_installation(
    ...
    result = clone_and_install("nonexistent-owner", "test-repo")
...
@patch("services.efs.clone_and_install.set_trigger")
@patch("services.efs.clone_and_install.set_owner_repo")
@patch("services.efs.clone_and_install.ensure_php_packages")
@patch("services.efs.clone_and_install.ensure_node_packages")
@patch("services.efs.clone_and_install.git_clone_to_efs")
...
@patch("services.efs.clone_and_install.get_installation_by_owner")
def test_clone_and_install_with_target_branch(
    mock_get_installation,
    mock_get_token,
    mock_get_repo,
    mock_get_efs_dir,
    ...
    result = clone_and_install("test-owner", "test-repo")
...
@patch("services.efs.clone_and_install.get_installation_access_token")
@patch("services.efs.clone_and_install.get_installation_by_owner")
def test_clone_and_install_with_default_branch(
    mock_get_installation,
    mock_get_token,
    mock_get_repo,
...
@patch("services.efs.clone_and_install.get_installation_access_token")
@patch("services.efs.clone_and_install.get_installation_by_owner")
def test_clone_and_install_empty_repository(
    mock_get_installation,
    mock_get_token,
    mock_get_repo,
    mock_get_default_branch,
