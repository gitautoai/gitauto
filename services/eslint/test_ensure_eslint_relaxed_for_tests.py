...
def test_returns_none_when_empty_content(create_test_base_args):
...
def test_returns_none_when_empty_filename(create_test_base_args):
...
def test_skips_js_config(create_test_base_args):
...
def test_skips_yaml_config(create_test_base_args):
...
def test_skips_flat_config(create_test_base_args):
...
def test_returns_none_when_invalid_json(create_test_base_args):
...
def test_skips_when_override_already_exists(create_test_base_args):
    existing_config = {
        "rules": {},
        "overrides": [
            {
...
def test_skips_when_override_exists_with_numeric_off(create_test_base_args):
    existing_config = {
        "rules": {},
        "overrides": [
            {
...
def test_adds_override_to_eslintrc_json(mock_replace: MagicMock, create_test_base_args):
...
@patch("services.eslint.ensure_eslint_relaxed_for_tests.write_and_commit_file")
def test_adds_override_to_eslintrc(mock_replace: MagicMock, create_test_base_args):
...
@patch("services.eslint.ensure_eslint_relaxed_for_tests.write_and_commit_file")
def test_appends_to_existing_overrides(mock_replace: MagicMock, create_test_base_args):
    existing_config = {
        "rules": {},
        "overrides": [
...
@patch("services.eslint.ensure_eslint_relaxed_for_tests.write_and_commit_file")
def test_wraps_in_package_json(
    mock_replace: MagicMock, mock_read: MagicMock, create_test_base_args
):
...
@patch("services.eslint.ensure_eslint_relaxed_for_tests.write_and_commit_file")
def test_returns_none_when_replace_fails(
    mock_replace: MagicMock, create_test_base_args
):
...
@patch("services.eslint.ensure_eslint_relaxed_for_tests.write_and_commit_file")
def test_real_foxquilt_eslintrc(mock_replace: MagicMock, create_test_base_args):
...
def test_does_not_match_override_without_test_glob(create_test_base_args):
    existing_config = {
        "overrides": [
            {
                "files": ["*.js"],
