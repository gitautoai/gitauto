...
def test_download_artifact_with_different_parameters():
    ...
    for owner, repo, artifact_id, token in test_cases:
        with patch("services.github.artifacts.download_artifact.get") as mock_get, \
            ...
            with patch("services.github.artifacts.download_artifact.zipfile.ZipFile") as mock_zipfile:
...
def test_download_artifact_url_construction():
    ...
    with patch("services.github.artifacts.download_artifact.get") as mock_get, \
         patch("services.github.artifacts.download_artifact.create_headers") as mock_create_headers, \
         patch("services.github.artifacts.download_artifact.zipfile.ZipFile") as mock_zipfile:
...
@pytest.mark.parametrize("owner,repo,artifact_id,token", [
