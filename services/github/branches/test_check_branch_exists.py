...
def test_check_branch_exists_returns_true_when_branch_exists(
    ...
    mock_create_headers.assert_called_once_with(
        token=sample_params["token"], media_type=""
    )
    mock_response.raise_for_status.assert_called_once()


def test_check_branch_exists_returns_false_when_branch_not_found(
    mock_requests_get, mock_create_headers, sample_params
):
...
def test_check_branch_exists_returns_false_for_empty_branch_name(
    mock_requests_get, mock_create_headers, sample_params
):
...
def test_check_branch_exists_returns_false_for_none_branch_name(
    mock_requests_get, mock_create_headers, sample_params
):
...
def test_check_branch_exists_handles_http_error_gracefully(
    mock_requests_get, mock_create_headers, sample_params
):
...
def test_check_branch_exists_handles_request_exception_gracefully(
    mock_requests_get, mock_create_headers, sample_params
):
...
def test_check_branch_exists_constructs_correct_url(
...
def test_check_branch_exists_passes_correct_headers(
    mock_requests_get, mock_create_headers, sample_params
):
...
def test_check_branch_exists_with_various_branch_names(
    mock_requests_get, mock_create_headers, branch_name
):
...
def test_check_branch_exists_with_empty_branch_names(
    mock_requests_get, mock_create_headers, empty_value
):
...
def test_check_branch_exists_with_success_status_codes(
    mock_requests_get, mock_create_headers, status_code
):
...
def test_check_branch_exists_with_error_status_codes_that_raise_for_status(
    mock_requests_get, mock_create_headers, status_code
):
