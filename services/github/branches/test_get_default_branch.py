...
class TestGetDefaultBranch:
    def test_successful_request(
        ...
        assert (
            second_call[1]["url"]
            == f"{GITHUB_API_URL}/repos/test-owner/test-repo/branches/main"
        )
    ...
    def test_different_default_branch(
        ...
        assert (
            second_call[1]["url"]
            == f"{GITHUB_API_URL}/repos/test-owner/test-repo/branches/develop"
        )
    ...
    def test_json_decode_error_repo_response(
    ...
    def test_json_decode_error_branch_response(
        ...
        branch_response = MagicMock()
        branch_response.raise_for_status.return_value = None
        branch_response.json.side_effect = json.JSONDecodeError(
            "Invalid JSON", "doc", 0
        )
    ...
    def test_function_parameters_types(
        self,
        mock_requests_get,
        mock_create_headers,
        sample_repo_response,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                f"{GITHUB_API_URL}/repos/special.user/repo_with_underscores",
            ),
        ],
    )
    ...
    def test_requests_timeout_parameter(
        self,
        mock_requests_get,
        mock_create_headers,
        sample_repo_response,
    ...
    def test_headers_passed_to_both_requests(
        self,
        mock_requests_get,
        mock_create_headers,
        sample_repo_response,
    ...
    def test_raise_for_status_called_on_both_responses(
        self,
        mock_requests_get,
        mock_create_headers,
        sample_repo_response,
    ...
    def test_json_called_on_both_responses(
        self,
        mock_requests_get,
        mock_create_headers,
        sample_repo_response,
    ...
    def test_various_branch_names_and_commit_shas(
        ...
        second_call = mock_requests_get.call_args_list[1]
        expected_branch_url = (
            f"{GITHUB_API_URL}/repos/test-owner/test-repo/branches/{default_branch}"
        )
        assert second_call[1]["url"] == expected_branch_url
