...
def mock_requests_get():
    ...
    with patch("services.github.collaborators.check_user_is_collaborator.requests.get") as mock:
        yield mock
...
def mock_create_headers():
    ...
    with patch("services.github.collaborators.check_user_is_collaborator.create_headers") as mock:
...
def test_check_user_is_collaborator_returns_true_for_204(mock_requests_get, mock_create_headers, sample_params):
...
def test_check_user_is_collaborator_returns_false_for_404(mock_requests_get, mock_create_headers, sample_params):
...
def test_check_user_is_collaborator_returns_false_for_non_204_success(mock_requests_get, mock_create_headers, sample_params):
...
def test_check_user_is_collaborator_constructs_correct_url(mock_requests_get, mock_create_headers, sample_params):
    ...
    # Assert
    expected_url = "https://api.github.com/repos/test-owner/test-repo/collaborators/test-user"
...
def test_check_user_is_collaborator_handles_http_error(mock_requests_get, mock_create_headers, sample_params):
...
def test_check_user_is_collaborator_handles_request_exception(mock_requests_get, mock_create_headers, sample_params):
...
def test_check_user_is_collaborator_with_special_characters_in_params(mock_requests_get, mock_create_headers):
...
def test_check_user_is_collaborator_status_code_handling(mock_requests_get, mock_create_headers, sample_params, status_code, expected_result):
