...
def test_get_all_comments_with_special_characters_in_repo_name(mock_requests_get, mock_create_headers):
...
def test_get_all_comments_with_various_issue_numbers(mock_requests_get, mock_create_headers, issue_number):
    ...
    # Assert
    expected_url = f"https://api.github.com/repos/{OWNER}/{REPO}/issues/{issue_number}/comments"
    call_args = mock_requests_get.call_args
    assert call_args[1]["url"] == expected_url
...
def test_get_all_comments_various_exceptions(base_args, mock_requests_get, mock_create_headers, error_type, error_message):
...
def test_get_all_comments_uses_github_api_url_constant(base_args, mock_requests_get, mock_create_headers):
    ...
    # Act
    with patch("services.github.comments.get_all_comments.GITHUB_API_URL", "https://custom.api.github.com"):
        get_all_comments(base_args)
    
    # Assert
    expected_url = f"https://custom.api.github.com/repos/{OWNER}/{REPO}/issues/123/comments"
    call_args = mock_requests_get.call_args
    assert call_args[1]["url"] == expected_url


def test_get_all_comments_response_with_complex_comment_structure(base_args, mock_requests_get, mock_create_headers):
...
def test_get_all_comments_multiple_calls_independence(base_args, mock_requests_get, mock_create_headers):
