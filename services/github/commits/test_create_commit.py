...
def test_create_commit_success(mock_requests_post, mock_create_headers, sample_base_args):
...
def test_create_commit_with_different_parameters(mock_requests_post, mock_create_headers):
    ...
    assert call_args.kwargs["url"] == "https://api.github.com/repos/test-owner/test-repo/git/commits"
...
def test_create_commit_with_empty_message(mock_requests_post, mock_create_headers, sample_base_args):
...
def test_create_commit_with_long_message(mock_requests_post, mock_create_headers, sample_base_args):
...
def test_create_commit_with_special_characters(mock_requests_post, mock_create_headers, sample_base_args):
...
def test_create_commit_with_different_sha_formats(mock_requests_post, mock_create_headers, sample_base_args):
    """Test commit creation with various SHA formats."""
    test_cases = [
        ("abc123", "def456"),  # Short SHAs
        ("1234567890abcdef", "fedcba0987654321"),  # Medium SHAs
        ("a1b2c3d4e5f6789012345678901234567890abcd", "f1e2d3c4b5a6789012345678901234567890fedc"),  # Full SHAs
...
def test_create_commit_json_parsing_error_handled(mock_create_headers, sample_base_args):
...
def test_create_commit_uses_correct_api_url(mock_requests_post, mock_create_headers, sample_base_args):
...
def test_create_commit_uses_correct_timeout(mock_requests_post, mock_create_headers, sample_base_args):
...
def test_create_commit_json_payload_structure(mock_requests_post, mock_create_headers, sample_base_args):
...
def test_create_commit_with_special_characters_in_owner_repo(mock_requests_post, mock_create_headers):
    ...
    call_args = mock_requests_post.call_args
    expected_url = "https://api.github.com/repos/test-owner_123/test.repo-name_456/git/commits"
    assert call_args.kwargs["url"] == expected_url


def test_create_commit_extracts_base_args_correctly(mock_requests_post, mock_create_headers):
...
def test_create_commit_return_value_type(mock_requests_post, mock_create_headers, sample_base_args):
...
def test_create_commit_handles_various_exceptions(mock_create_headers, sample_base_args, error_type, error_message):
