...
class TestGetIssueBody:
    ...
    def test_get_issue_body_successful_response(self, mock_graphql_client, sample_params):
    ...
    def test_get_issue_body_missing_repository(self, mock_graphql_client, sample_params):
    ...
    def test_get_issue_body_missing_body_field(self, mock_graphql_client, sample_params):
    ...
    def test_get_issue_body_graphql_query_structure(self, mock_graphql_client, sample_params):
        ...
        variable_values = call_args.kwargs.get("variable_values") or call_args[1]["variable_values"]
        expected_variables = {
...
End of issue body."""
    ...
    def test_get_issue_body_special_characters(self, mock_graphql_client, sample_params):
    ...
    def test_get_issue_body_exception_handling_returns_none(self, mock_graphql_client, sample_params):
    ...
    def test_get_issue_body_key_error_handling(self, mock_graphql_client, sample_params):
    ...
    def test_get_issue_body_malformed_response(self, mock_graphql_client, sample_params):
    ...
    def test_get_issue_body_return_type_consistency(self, mock_graphql_client, sample_params):
    ...
    def test_get_issue_body_graphql_variables_mapping(self, mock_graphql_client, sample_params):
