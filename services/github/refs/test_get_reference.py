...
def test_get_reference_success(base_args, mock_response, mock_requests_get, mock_create_headers):
...
def test_get_reference_404_returns_none(base_args, mock_404_response, mock_requests_get, mock_create_headers):
...
def test_get_reference_constructs_correct_url(base_args, mock_response, mock_requests_get, mock_create_headers):
    """Test that the correct GitHub API URL is constructed."""
    mock_requests_get.return_value = mock_response
    
    get_reference(base_args)
    
    expected_url = "https://api.github.com/repos/test-owner/test-repo/git/ref/heads/test-branch"
...
def test_get_reference_with_different_branch_names(mock_response, mock_requests_get, mock_create_headers):
    ...
    for branch_name in test_cases:
        ...
        assert result == "abc123def456"
        expected_url = f"https://api.github.com/repos/owner/repo/git/ref/heads/{branch_name}"
...
def test_get_reference_with_special_characters_in_params(mock_response, mock_requests_get, mock_create_headers):
...
def test_get_reference_http_error_non_404(base_args, mock_requests_get, mock_create_headers):
...
def test_get_reference_connection_error(base_args, mock_requests_get, mock_create_headers):
...
def test_get_reference_json_decode_error(base_args, mock_requests_get, mock_create_headers):
...
def test_get_reference_missing_object_key(base_args, mock_requests_get, mock_create_headers):
...
def test_get_reference_missing_sha_key(base_args, mock_requests_get, mock_create_headers):
    """Test handling when response JSON is missing 'sha' key in object."""
    mock_response = MagicMock()
    mock_response.status_code = 200
    mock_response.json.return_value = {"object": {"type": "commit"}}  # Missing 'sha' key
    mock_requests_get.return_value = mock_response
...
def test_get_reference_empty_response(base_args, mock_requests_get, mock_create_headers):
...
def test_get_reference_null_sha_value(base_args, mock_requests_get, mock_create_headers):
...
def test_get_reference_returns_string_sha(base_args, mock_requests_get, mock_create_headers):
...
def test_get_reference_various_http_errors(base_args, mock_requests_get, mock_create_headers, status_code):
...
def test_get_reference_calls_raise_for_status_on_non_404(base_args, mock_requests_get, mock_create_headers):
