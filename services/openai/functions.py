...
COMMENT_URL: dict[str, str] = {
    "type": "string",
    "description": "URL of the comment on the github issue",
}
UNIQUE_ISSUE_ID: dict[str, str] = {
    "type": "string",
    "description": "A unique issue id to identify the github issue.",
}
