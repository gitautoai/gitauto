...
Given information such as a pull request title, body, changes, workflow file
content, and check run error log, identify the cause of the Check Run failure.
...
Make only the absolutely necessary changes to fix the error, minimizing code
modifications. Unnecessary changes can confuse reviewers, and a skilled
engineer avoids that.
