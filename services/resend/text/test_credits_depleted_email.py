...
def test_get_credits_depleted_email_text_includes_dashboard_url():
    ...
    with patch("services.resend.text.credits_depleted_email.DASHBOARD_CREDITS_URL", "https://test.com/credits"):
...
def test_get_credits_depleted_email_text_includes_email_signature():
    ...
    with patch("services.resend.text.credits_depleted_email.EMAIL_SIGNATURE", "Custom Signature"):
