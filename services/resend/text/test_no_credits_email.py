...
def test_get_no_credits_email_text_includes_dashboard_url():
    ...
    with patch('services.resend.text.no_credits_email.DASHBOARD_CREDITS_URL', 'https://test.gitauto.ai/dashboard/credits'):
...
def test_get_no_credits_email_text_includes_email_signature():
    ...
    with patch('services.resend.text.no_credits_email.EMAIL_SIGNATURE', 'Test Signature'):
        subject, text = get_no_credits_email_text("TestUser")
