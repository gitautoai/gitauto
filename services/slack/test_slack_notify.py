...
def mock_slack_token():
    ...
    with patch.dict(os.environ, {"SLACK_BOT_TOKEN": "xoxb-test-token-123"}):
        with patch("services.slack.slack_notify.SLACK_BOT_TOKEN", "xoxb-test-token-123"):
...
def test_slack_notify_success_without_thread(mock_requests_post, mock_is_prd_true, mock_slack_token):
...
def test_slack_notify_success_with_thread(mock_requests_post, mock_is_prd_true, mock_slack_token):
...
def test_slack_notify_http_error_status_code(mock_requests_post, mock_is_prd_true, mock_slack_token):
...
def test_slack_notify_slack_api_error_response(mock_requests_post, mock_is_prd_true, mock_slack_token):
...
def test_slack_notify_requests_exception(mock_requests_post, mock_is_prd_true, mock_slack_token):
...
def test_slack_notify_with_empty_message(mock_requests_post, mock_is_prd_true, mock_slack_token):
...
def test_slack_notify_with_special_characters(mock_requests_post, mock_is_prd_true, mock_slack_token):
...
def test_slack_notify_timeout_parameter(mock_requests_post, mock_is_prd_true, mock_slack_token):
...
def test_slack_notify_channel_parameter(mock_requests_post, mock_is_prd_true, mock_slack_token):
...
def test_slack_notify_headers_structure(mock_requests_post, mock_is_prd_true, mock_slack_token):
...
def test_slack_notify_json_decode_error(mock_requests_post, mock_is_prd_true, mock_slack_token):
...
def test_slack_notify_missing_ts_in_response(mock_requests_post, mock_is_prd_true, mock_slack_token):
...
def test_slack_notify_thread_ts_none_explicitly(mock_requests_post, mock_is_prd_true, mock_slack_token):
