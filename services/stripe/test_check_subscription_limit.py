...
def test_check_subscription_limit_handles_get_base_request_limit_exception(
    ...
    # Setup mocks - get_base_request_limit raises exception
...
def test_check_subscription_limit_handles_count_requests_exception(
    ...
    # Setup mocks - count_completed_unique_requests raises exception
    mock_get_base_request_limit.return_value = 100
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("month", 100, 2, 200),
        ("month", 50, 3, 150),
        ("year", 100, 1, 1200),  # 100 * 12 * 1
        ("year", 100, 2, 2400),  # 100 * 12 * 2
        ("year", 50, 3, 1800),   # 50 * 12 * 3
    ],
)
