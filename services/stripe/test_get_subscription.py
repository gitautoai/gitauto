...
def test_get_subscription_with_no_subscriptions(mock_stripe, mock_subscription_list_response):
...
def test_get_subscription_with_single_subscription(mock_stripe, mock_subscription_list_response):
...
def test_get_subscription_with_multiple_subscriptions(mock_stripe, mock_subscription_list_response):
    ...
    assert result == mock_subscription_list_response
    assert len(result.data) == 1
    assert result.data[0] == mock_subscription2  # Should return the highest priced subscription
...
def test_get_subscription_with_pagination(mock_stripe):
    ...
    mock_stripe.Subscription.list.side_effect = [first_page_response, second_page_response]
...
def test_get_subscription_with_empty_customer_id(mock_stripe, mock_subscription_list_response):
...
def test_get_subscription_with_equal_priced_subscriptions(mock_stripe, mock_subscription_list_response):
