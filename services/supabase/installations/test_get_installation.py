...
class TestGetInstallation:
    ...
    def test_get_installation_returns_installation_when_found(self, mock_supabase_query, sample_installation_data):
    ...
    def test_get_installation_returns_first_installation_when_multiple_found(self, mock_supabase_query):
    ...
    def test_get_installation_returns_none_when_no_data_found(self, mock_supabase_query):
    ...
    def test_get_installation_returns_none_when_exception_occurs(self, mock_supabase_query):
    ...
    def test_get_installation_returns_none_when_type_error_occurs(self, mock_supabase_query):
    ...
    def test_get_installation_with_user_type_installation(self, mock_supabase_query, sample_user_installation_data):
    ...
    def test_get_installation_calls_correct_supabase_methods(self, mock_supabase_query):
        ...
        with patch("services.supabase.installations.get_installation.supabase") as mock_supabase:
            mock_table = MagicMock()
            mock_select = MagicMock()
            mock_eq = MagicMock()
            mock_is = MagicMock()
    ...
    def test_get_installation_with_complete_installation_data(self, mock_supabase_query):
    ...
    @pytest.mark.parametrize("owner_id,expected_installation_id", [
        (1, 11111),
        (999999999, 22222),
        (123456789, 33333),
        (0, 44444),  # Edge case: zero owner_id
    ])
    def test_get_installation_with_various_owner_ids_parametrized(self, mock_supabase_query, owner_id, expected_installation_id):
...
def test_get_installation_with_type_casting_behavior(mock_supabase_query, sample_installation_data):
    ...
    expected_fields = ["installation_id", "owner_id", "owner_name", "owner_type", "created_at", "created_by", "uninstalled_at", "uninstalled_by"]
