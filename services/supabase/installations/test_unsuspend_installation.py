...
def mock_supabase():
    ...
    with patch("services.supabase.installations.unsuspend_installation.supabase") as mock:
...
def test_unsuspend_installation_with_various_installation_ids(mock_supabase, installation_id):
