...
def test_update_stripe_customer_id_success(mock_supabase):
    ...
    # Execute
    result = update_stripe_customer_id(owner_id=123456, stripe_customer_id="cus_test123")

    # Assert
    mock_supabase.table.assert_called_once_with("owners")
    mock_supabase.table().update.assert_called_once_with({"stripe_customer_id": "cus_test123"})
...
def test_update_stripe_customer_id_with_long_customer_id(mock_supabase):
    ...
    # Execute
    result = update_stripe_customer_id(owner_id=456, stripe_customer_id=long_customer_id)

    # Assert
    mock_supabase.table().update.assert_called_once_with({"stripe_customer_id": long_customer_id})
...
def test_update_stripe_customer_id_with_special_characters(mock_supabase):
    ...
    # Execute
    result = update_stripe_customer_id(owner_id=999, stripe_customer_id=special_customer_id)

    # Assert
    mock_supabase.table().update.assert_called_once_with({"stripe_customer_id": special_customer_id})
...
def test_update_stripe_customer_id_with_unicode_characters(mock_supabase):
    ...
    # Execute
    result = update_stripe_customer_id(owner_id=111, stripe_customer_id=unicode_customer_id)

    # Assert
    mock_supabase.table().update.assert_called_once_with({"stripe_customer_id": unicode_customer_id})
...
def test_update_stripe_customer_id_with_negative_owner_id(mock_supabase):
    ...
    # Execute
    result = update_stripe_customer_id(owner_id=-1, stripe_customer_id="cus_negative123")
...
def test_update_stripe_customer_id_with_large_owner_id(mock_supabase):
    ...
    # Execute
    result = update_stripe_customer_id(owner_id=large_owner_id, stripe_customer_id="cus_large123")

    # Assert
    mock_supabase.table().update().eq.assert_called_once_with("owner_id", large_owner_id)
    assert result is None
...
def test_update_stripe_customer_id_whitespace_handling(mock_supabase):
    ...
    # Execute
    result = update_stripe_customer_id(owner_id=5001, stripe_customer_id=customer_id_with_spaces)

    # Assert - whitespace should be preserved as-is
    mock_supabase.table().update.assert_called_once_with({"stripe_customer_id": customer_id_with_spaces})
    assert result is None
...
def test_update_stripe_customer_id_parametrized(mock_supabase, owner_id, stripe_customer_id):
    """Test function with various parameter combinations using parametrize."""
    # Execute
    result = update_stripe_customer_id(owner_id=owner_id, stripe_customer_id=stripe_customer_id)

    # Assert
    mock_supabase.table().update.assert_called_once_with({"stripe_customer_id": stripe_customer_id})
...
def test_update_stripe_customer_id_return_value_on_success(mock_supabase):
    ...
    # Execute
    result = update_stripe_customer_id(owner_id=3001, stripe_customer_id="cus_return123")
