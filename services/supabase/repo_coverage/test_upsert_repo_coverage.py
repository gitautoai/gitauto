...
class TestUpsertRepoCoverage:
    def test_successful_upsert_with_full_data(self, mock_supabase_client, sample_repo_coverage_data):
        ...
        mock_supabase_client.table.return_value.insert.assert_called_once_with(expected_insert_data)
        mock_supabase_client.table.return_value.insert.return_value.execute.assert_called_once()

    def test_successful_upsert_with_minimal_data(self, mock_supabase_client, minimal_repo_coverage_data):
    ...
    def test_supabase_operation_chain(self, mock_supabase_client, sample_repo_coverage_data):
