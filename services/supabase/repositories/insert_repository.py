from schemas.supabase.fastapi.schema_public_latest import RepositoriesInsert
...
def insert_repository(
    ...
    repository_data = RepositoriesInsert(
        owner_id=owner_id,
        repo_id=repo_id,
        repo_name=repo_name,
    ...
    insert_result = (
        supabase.table("repositories").insert(repository_data_dict).execute()
    )
