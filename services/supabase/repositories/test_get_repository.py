...
def test_get_repository_attribute_error():
    ...
    with patch(
        ...
        mock_supabase.table.return_value.select.return_value.eq.return_value.execute.side_effect = AttributeError(
...
def test_get_repository_type_error():
    ...
    with patch(
        ...
        mock_supabase.table.return_value.select.return_value.eq.return_value.execute.side_effect = TypeError(
