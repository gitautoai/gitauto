...
def test_get_repository_features_success(mock_supabase):
    ...
    result = get_repository_features(platform="github", owner_id=12345, repo_id=123456)
    ...
    mock_eq1.eq.assert_called_once_with("owner_id", 12345)
    mock_eq2.eq.assert_called_once_with("repo_id", 123456)
...
def test_get_repository_features_not_found(mock_supabase):
    ...
    result = get_repository_features(platform="github", owner_id=12345, repo_id=999999)
