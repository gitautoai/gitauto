...
class TestHandleWebhookEvent:
    ...
    async def test_handle_webhook_event_installation_repos_added(
        ...
        await handle_webhook_event(event_name="installation_repositories", payload=payload)
    ...
    async def test_handle_webhook_event_issues_opened(self, mock_create_gitauto_button_comment):
    ...
    async def test_handle_webhook_event_check_run_completed_failure(self, mock_handle_check_run):
    ...
    async def test_handle_webhook_event_check_run_completed_success(self, mock_handle_check_run):
    ...
    async def test_handle_webhook_event_pull_request_review_comment_created(
        ...
        await handle_webhook_event(event_name="pull_request_review_comment", payload=payload)
