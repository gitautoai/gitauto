...
class TestGetRawContent:
    ...
    def test_successful_file_retrieval(
        self, mock_create_headers, mock_requests_get, mock_response_success
    ):
        ...
        result = get_raw_content(
            "test-owner", "test-repo", "test.py", "main", "test-token"
        )
    ...
    def test_file_not_found_404(
        self, mock_create_headers, mock_requests_get, mock_response_404
    ):
    ...
    def test_directory_returns_none(
        self, mock_create_headers, mock_requests_get, mock_response_directory
    ):
    ...
    def test_response_without_content_field(
        self, mock_create_headers, mock_requests_get, mock_response_no_content
    ):
    ...
    def test_server_error_handled_by_decorator(
        self, mock_create_headers, mock_requests_get, mock_response_500
    ):
    ...
    def test_json_decode_error_handled_by_decorator(
        self, mock_create_headers, mock_requests_get
    ):
    ...
    def test_special_characters_in_file_path(
        ...
        result = get_raw_content(
            "test-owner", "test-repo", file_path, "main", "test-token"
        )
    ...
    def test_various_http_error_codes(
        self, mock_create_headers, mock_requests_get, status_code
    ):
    ...
    def test_various_file_types(
        self, mock_create_headers, mock_requests_get, file_extension, content
    ):
