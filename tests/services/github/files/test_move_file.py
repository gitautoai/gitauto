...
class TestMoveFile:
    ...
    @patch("services.github.files.move_file.get_commit")
    @patch("services.github.files.move_file.get_reference")
    def test_file_not_found_error(self, mock_get_reference, mock_get_commit, mock_get_file_tree, base_args, mock_tree_items):
        ...
        mock_get_reference.assert_called_once_with(base_args)
        mock_get_commit.assert_called_once_with(base_args, "commit_sha_123")
        mock_get_file_tree.assert_called_once_with("test-owner", "test-repo", "tree_sha_456", "test-token")

    @patch("services.github.files.move_file.get_file_tree")
    @patch("services.github.files.move_file.get_commit")
    @patch("services.github.files.move_file.get_reference")
    def test_target_file_exists_error(self, mock_get_reference, mock_get_commit, mock_get_file_tree, base_args, mock_tree_items):
    ...
    @patch("services.github.files.move_file.get_commit")
    @patch("services.github.files.move_file.get_reference")
    def test_create_tree_failure(self, mock_get_reference, mock_get_commit, mock_get_file_tree, mock_create_tree, base_args, mock_tree_items):
        ...
        mock_create_tree.assert_called_once_with(base_args, "tree_sha_456", expected_tree_items)
    ...
    @patch("services.github.files.move_file.get_commit")
    @patch("services.github.files.move_file.get_reference")
    def test_create_commit_failure(self, mock_get_reference, mock_get_commit, mock_get_file_tree, mock_create_tree, mock_create_commit, base_args, mock_tree_items):
        ...
        mock_create_commit.assert_called_once_with(
            base_args, "Move old/file.py to new/path.py", "new_tree_sha_789", "commit_sha_123"
        )
    ...
    @patch("services.github.files.move_file.get_commit")
    @patch("services.github.files.move_file.get_reference")
    def test_successful_move_without_skip_ci(self, mock_get_reference, mock_get_commit, mock_get_file_tree, mock_create_tree, mock_create_commit, mock_update_reference, base_args, mock_tree_items):
    ...
    @patch("services.github.files.move_file.get_commit")
    @patch("services.github.files.move_file.get_reference")
    def test_successful_move_with_skip_ci(self, mock_get_reference, mock_get_commit, mock_get_file_tree, mock_create_tree, mock_create_commit, mock_update_reference, base_args, mock_tree_items):
        ...
        mock_create_tree.assert_called_once()
        mock_create_commit.assert_called_once_with(
            base_args, "Move old/file.py to new/path.py [skip ci]", "new_tree_sha_789", "commit_sha_123"
        )
        mock_update_reference.assert_called_once_with(base_args, "new_commit_sha_abc")
    ...
    @patch("services.github.files.move_file.get_commit")
    @patch("services.github.files.move_file.get_reference")
    def test_file_search_with_non_blob_items(self, mock_get_reference, mock_get_commit, mock_get_file_tree, base_args):
    ...
    @patch("services.github.files.move_file.get_commit")
    @patch("services.github.files.move_file.get_reference")
    def test_target_file_check_with_non_blob_items(self, mock_get_reference, mock_get_commit, mock_get_file_tree, base_args):
        ...
        with patch("services.github.files.move_file.create_tree") as mock_create_tree:
            mock_create_tree.return_value = None  # Force failure to verify we got past the target check
            result = move_file("old/file.py", "new/path.py", base_args)
    ...
    @patch("services.github.files.move_file.get_commit")
    @patch("services.github.files.move_file.get_reference")
    def test_empty_tree_items(self, mock_get_reference, mock_get_commit, mock_get_file_tree, base_args):
    ...
    @patch("services.github.files.move_file.get_commit")
    @patch("services.github.files.move_file.get_reference")
    def test_different_file_modes(self, mock_get_reference, mock_get_commit, mock_get_file_tree, mock_create_tree, mock_create_commit, mock_update_reference, base_args):
