...
class TestGetIssueBodyForPrMerged:
    ...
    def mock_settings_links(self):
        ...
        with patch("utils.issue_templates.merge.SETTINGS_LINKS", "MOCK_SETTINGS_LINKS"):
            yield mock
    ...
    def test_get_issue_body_for_pr_merged_files_with_special_characters(self, mock_settings_links):
    ...
    def test_get_issue_body_for_pr_merged_structure_consistency(self, mock_settings_links):
