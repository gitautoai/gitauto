...
class TestGetIssueBody:
    ...
    def mock_constants(self):
        ...
        with patch("utils.issue_templates.schedule.GH_BASE_URL", "https://github.com") as mock_gh_url, \
             patch("utils.issue_templates.schedule.SETTINGS_LINKS", "MOCK_SETTINGS_LINKS") as mock_settings:
    ...
    def test_get_issue_body_nested_file_paths(self, mock_constants):
        ...
        expected_url = "https://github.com/owner/repo/blob/main/very/deeply/nested/path/to/file.py"
