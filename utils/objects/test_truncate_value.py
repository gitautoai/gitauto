...
def test_truncate_string_equal_to_max():
    """Test string exactly matching max_length"""
    string = "Exactly 30 characters long!!!!!!"  # 30 chars
...
def test_truncate_dict():
    """Test dictionary with mixed length values"""
    test_dict = {
...
def test_truncate_list():
    """Test list with mixed length values"""
...
def test_truncate_tuple():
    """Test tuple with mixed length values"""
...
def test_non_string_values():
    ...
    assert truncate_value(False, 10) is False
...
def test_string_exactly_at_truncation_point():
    """Test string that would be exactly at truncation point with suffix"""
    # For max_length 10, we use 6 chars + " ..." (4 chars)
